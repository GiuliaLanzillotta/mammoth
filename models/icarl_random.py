...
def fill_buffer(self, mem_buffer: Buffer, dataset, t_idx: int) -> None:
    ...
    # 2.2 Add samples in the buffer class by class
...
class ICarlRandom(ContinualModel):
    NAME = 'icarl_random'
    COMPATIBILITY = ['class-il', 'task-il']

    def __init__(self, backbone, loss, args, transform):
        super(ICarlRandom, self).__init__(backbone, loss, args, transform)
